 ...
 */
const SW_VERSION = 'v1.6.17';  // v1.6.17: "Log in with LINE" via PocketBase authWithOAuth2 (cloud-sync accounts only); dashboard greeting personalizes from the LINE profile name when no firstName was captured (EN+TH); APP_VERSION 2.6.12->2.6.13
