 ...
 */
const SW_VERSION = 'v1.6.17';  // v1.6.17: dashboard reprioritized around revenue/trip — "Avg / session" (net) -> "Avg revenue / trip" (gross); profit-insight card leads with earn-per-hour instead of margin/coach framing; APP_VERSION 2.6.12->2.6.13
