 ...
 */
const SW_VERSION = 'v1.10.6';  // v1.10.6: removed the redundant "End date" field from the session form (hidden input still carries it for overnight-shift auto-advance); APP_VERSION 2.10.5->2.10.6
